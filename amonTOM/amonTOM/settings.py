...
Generated by ./manage.py tom_setup on Nov. 26, 2019, 4:47 p.m.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'amon_extras': 'amonTOM.templatetags.amon_extras',
...
WSGI_APPLICATION = 'amonTOM.wsgi.application'
...
# Settings that are recomended to set to true when https is set up
